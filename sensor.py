...
from esphome.const import CONF_ID, CONF_NAME, CONF_ADDRESS, CONF_UPDATE_INTERVAL, UNIT_NONE, ICON_COUNTER
...
CONFIG_SCHEMA = (
    sensor.sensor_schema(unit=UNIT_NONE, icon=ICON_COUNTER, accuracy_decimals=0)
    .extend(
        {
...
async def to_code(config):
    ...
    # Register the sensor (name, icon, etc.) with ESPHome
